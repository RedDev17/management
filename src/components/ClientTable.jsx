...
export default function ClientTable({ filterDev }) {
  ...
  const handleComplete = async () => {
    ...
    const result = await completeClient(confirmComplete.id);
    if (result?.error) {
      ...
      {confirmComplete && (
        <div style={{
          ...
          <div className="glass-panel" style={{
            ...
            <h3 style={{ marginBottom: '0.5rem', fontSize: '1.2rem' }}>Mark as Completed?</h3>
            <p style={{ color: '#64748b', marginBottom: '1.5rem', fontSize: '0.95rem' }}>
              Are you sure you want to mark <strong>"{confirmComplete.name}"</strong> as completed? This will move them to the History section.
            </p>
